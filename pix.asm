...
; r14 i inne rejestry modyfikowane z makr DIV_FRA i POW_MOD.
...
.first_loop:
  ...
  sub     rbp, r14                    ; rbp = n - k
  POW_MOD rbp, rdi
  DIV_FRA r8, rdi                     ; W r8 jest wynik POW_MOD.
  add     r9, rax                     ; W rax jest wynik DIV_FRA.
  inc     r14
  jmp     .first_loop
.first_loop_exit:
...
pix_loop:
  ...
  shl     r15, 3                      ; r15 = 8 * m
  PI
  shr     r10, 32                     ; Chcemy mieć starsze 32 bity.
